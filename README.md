...
# ou empacotando
helm package .
helm install minha-app base-template-chart-1.2.0.tgz
```
...
1. Extrai a versão da tag (`v1.2.0` → `1.2.0`).
...
(`<registry>/<prefix>/base-template-chart:1.2.0` ou por digest `...@sha256:...`).
